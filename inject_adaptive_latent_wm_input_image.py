...
# 35
    ...
    for blending_factor in blending_factors:
        for steps in [90]:  # injection steps
            ...
            ssim_metrics = []
            msssim_metrics = []
            for data_type in ["lq","hq"]:
                root_dir = f"/media/NAS/DATASET/AADD-2025_Challenge/AADD-2025/Dataset/test/fake/{data_type}"
                for root, _, files in os.walk(root_dir):
                    for file in files:
                        if file.lower().endswith(exts):
                            ...
                            current_prompt = "Smiling"#dataset[i][prompt_key]
                            ...
                            orig_image_no_w = outputs_no_w.images[0]
                            orig_image_no_w.save(f'generated_imgs/clean-test/{data_type}/{file}')
                            ...
                            orig_image_w.save(f'generated_imgs/test/{data_type}/{file}')
                            ...
                            #     orig_image_no_w_auged, orig_image_w_auged = image_distortion(orig_image_no_w, orig_image_w, seed, attack,index=i)
