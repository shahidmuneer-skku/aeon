...
from stable_diffusion_aeon import AEONStableDiffusionPipeline  # opt prompt
...
class InversableStableDiffusionPipeline(AEONStableDiffusionPipeline):
    def __init__(self,
        vae,
        text_encoder,
        tokenizer,
    ...
    def backward_diffusion(
        ...
        **kwargs,
        ...
        # print(f'reverse timesteps: {reversed(timesteps_tensor)}')
        # 200, 400, 599, 799, 999
        noise_b = []
        ...
        for i, t in enumerate(self.progress_bar(timesteps_tensor if not reverse_process else reversed(timesteps_tensor))):
            ...
            # if (i+1) % 5 == 0 and latents_b is not None:
        ...
        if latents_b is not None:
            return latents, latents_b, noise_b#, vtime   
